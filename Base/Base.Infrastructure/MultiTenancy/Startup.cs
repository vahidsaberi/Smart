...
internal static class Startup
{
    internal static IServiceCollection AddMultitenancy(this IServiceCollection services)
    {
        return services
            ...
            .AddMultiTenant<SmartTenantInfo>()
                .WithClaimStrategy(SmartClaims.Tenant)
                .WithHeaderStrategy(MultitenancyConstants.TenantIdName)
                .WithQueryStringStrategy(MultitenancyConstants.TenantIdName)
                .WithEFCoreStore<TenantDbContext, SmartTenantInfo>()
                .Services
    ...
    private static FinbuckleMultiTenantBuilder<SmartTenantInfo> WithQueryStringStrategy(this FinbuckleMultiTenantBuilder<SmartTenantInfo> builder, string queryStringKey) =>
