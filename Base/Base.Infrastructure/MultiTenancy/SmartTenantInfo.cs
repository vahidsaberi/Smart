...
public class SmartTenantInfo : ITenantInfo
{
    public SmartTenantInfo()
    {
    }

    public SmartTenantInfo(string id, string name, string? connectionString, string adminEmail, string? issuer = null)
    {
        Id = id;
        Identifier = id;
        Name = name;
